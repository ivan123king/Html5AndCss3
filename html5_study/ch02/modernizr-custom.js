...
!function (window, document, undefined) {
    ...
    function injectElementWithStyles(A, e, t, r) {
        var n, o, i, d, a = "modernizr", s = createElement("div"), l = getBody();
        if (parseInt(t, 10))for (; t--;)i = createElement("div"), i.id = r ? r[t] : a + (t + 1), s.appendChild(i);
    ...
    function computedStyle(A, e, t) {
        ...
        if ("getComputedStyle" in window) {
            ...
            if (null !== r)t && (r = r.getPropertyValue(t)); else if (n) {
    ...
    function testDOMProps(A, e, t) {
        var r;
        for (var n in A)if (A[n] in e)return t === !1 ? A[n] : (r = e[A[n]], is(r, "function") ? fnBind(r, t || e) : r);
        return !1
    }

    function testPropsAll(A, e, t, r, n) {
        var o = A.charAt(0).toUpperCase() + A.slice(1), i = (A + " " + cssomPrefixes.join(o + " ") + o).split(" ");
    ...
    var docElement = document.documentElement, isSVG = "svg" === docElement.nodeName.toLowerCase(), prefixes = ModernizrProto._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
    ModernizrProto._prefixes = prefixes;
    var html5;
    isSVG || !function (A, e) {
        function t(A, e) {
            var t = A.createElement("p"), r = A.getElementsByTagName("head")[0] || A.documentElement;
    ...
    }), Modernizr.addTest("cors", "XMLHttpRequest" in window && "withCredentials" in new XMLHttpRequest), Modernizr.addTest("contextmenu", "contextMenu" in docElement && "HTMLMenuItemElement" in window), Modernizr.addTest("customelements", "customElements" in window), Modernizr.addTest("customevent", "CustomEvent" in window && "function" == typeof window.CustomEvent), Modernizr.addTest("customprotocolhandler", function () {
    ...
    Modernizr.addTest("supports", newSyntax || oldSyntax), Modernizr.addTest("target", function () {
        ...
        return !0
    }), Modernizr.addTest("es6collections", !!(window.Map && window.Set && window.WeakMap && window.WeakSet)), Modernizr.addTest("contains", is(String.prototype.contains, "function")), Modernizr.addTest("generators", function () {
        try {
    ...
    !function () {
        ...
        function A(A, e, t) {
            function r(e) {
                var r = e && "load" === e.type ? 1 == n.width : !1, o = "webp" === A;
        ...
        A(t.name, t.uri, function (t) {
            if (t && "load" === t.type)for (var r = 0; r < e.length; r++)A(e[r].name, e[r].uri)
        })
        ...
        try {
            var t = window.BlobBuilder, r = window.URL;
            ...
            var n, o, i, d, a, s = "Modernizr", l = "this.onmessage=function(e){postMessage(e.data)}";
            try {
    ...
    var prefixedCSSValue = function (A, e) {
        var t = !1, r = createElement("div"), n = r.style;
        if (A in n) {
    ...
    ModernizrProto.prefixedCSSValue = prefixedCSSValue, Modernizr.addTest("audio", function () {
        ...
        var A = window.devicePixelRatio || 1, e = 12 * A, t = createElement("canvas"), r = t.getContext("2d");
        ...
        var e, t = 300, r = createElement("audio"), n = r.style;
    ...
    Modernizr.addTest("todataurljpeg", function () {
        ...
        var i = createElement("a"), d = i.style;
        ...
        var A = "position:", e = "sticky", t = createElement("a"), r = t.style;
        ...
        var t = createElement("ruby"), r = createElement("rt"), n = createElement("rp"), o = "display", i = "fontSize";
        ...
        for (var t = 0, r = domPrefixes.length; r > t; t++)if (domPrefixes[t] + e in A)return !0;
        return !1
    }), Modernizr.addTest("formattribute", function () {
        var A, e = createElement("form"), t = createElement("input"), r = createElement("div"), n = "formtest" + (new Date).getTime(), o = !1;
        e.id = n;
        try {
        ...
        var A, e, t, r = createElement("img"), n = "sizes" in r;
        ...
        var e, t = 200, r = 5, n = 0, o = createElement("video"), i = o.style;
        ...
        if (A = !("plugins" in navigator && "Shockwave Flash" in navigator.plugins || e), A || isSVG)n(!1); else {
    ...
    blacklist ? Modernizr.addTest("fontface", !1) : testStyles('@font-face {font-family:"font";src:url("https://")}', function (A, e) {
        var t = document.getElementById("smodernizr"), r = t.sheet || t.styleSheet, n = r ? r.cssRules && r.cssRules[0] ? r.cssRules[0].cssText : r.cssText || "" : "", o = /src/i.test(n) && 0 === n.indexOf(e.split(" ")[0]);
    ...
    Modernizr.inputtypes = function (A) {
        ...
        var A, e = createElement("div"), t = getBody(), r = function () {
    ...
    Modernizr._q.push(function () {
        ...
        var e = parseInt(window.innerHeight / 2, 10), t = parseInt(computedStyle(A, null, "height"), 10);
        Modernizr.addTest("cssvhunit", t == e)
    }), testStyles("#modernizr { width: 50vw; }", function (A) {
        var e = parseInt(window.innerWidth / 2, 10), t = parseInt(computedStyle(A, null, "width"), 10);
        ...
        var e = A.childNodes[2], t = A.childNodes[1], r = A.childNodes[0], n = parseInt((t.offsetWidth - t.clientWidth) / 2, 10), o = r.clientWidth / 100, i = r.clientHeight / 100, d = parseInt(50 * Math.max(o, i), 10), a = parseInt(computedStyle(e, null, "width"), 10);
        ...
        var e = A.childNodes[2], t = A.childNodes[1], r = A.childNodes[0], n = parseInt((t.offsetWidth - t.clientWidth) / 2, 10), o = r.clientWidth / 100, i = r.clientHeight / 100, d = parseInt(50 * Math.min(o, i), 10), a = parseInt(computedStyle(e, null, "width"), 10);
    ...
    Modernizr.addTest("crypto", !!prefixed("subtle", crypto)), Modernizr.addTest("dart", !!prefixed("startDart", navigator)), Modernizr.addTest("forcetouch", function () {
    ...
    }), Modernizr.addTest("gamepads", !!prefixed("getGamepads", navigator)), Modernizr.addTest("fullscreen", !(!prefixed("exitFullscreen", document, !1) && !prefixed("cancelFullScreen", document, !1))), Modernizr.addAsyncTest(function () {
        var A;
        try {
        ...
        if (A) {
            var t = "modernizr-" + Math.random(), r = A.open(t);
            r.onerror = function () {
        ...
        var A, e, t, r, n = "detect-blob-support", o = !1;
        try {
            A = prefixed("indexedDB", window)
        } catch (i) {
        }
    ...
    }), Modernizr.addTest("intl", !!prefixed("Intl", window)), Modernizr.addTest("performance", !!prefixed("performance", window)), Modernizr.addTest("pointerlock", !!prefixed("exitPointerLock", document)), Modernizr.addTest("quotamanagement", function () {
    ...
    Modernizr.addTest("getrandomvalues", !!supportsGetRandomValues), Modernizr.addTest("backgroundblendmode", prefixed("backgroundBlendMode", "text")), Modernizr.addTest("regions", function () {
        if (isSVG)return !1;
        var A = prefixed("flowFrom"), e = prefixed("flowInto"), t = !1;
        if (!A || !e)return t;
        var r = createElement("iframe"), n = createElement("div"), o = createElement("div"), i = createElement("div"), d = "modernizr_flow_for_regions_check";
    ...
    }), Modernizr.addTest("objectfit", !!prefixed("objectFit"), {aliases: ["object-fit"]}), Modernizr.addTest("wrapflow", function () {
        var A = prefixed("wrapFlow");
        if (!A || isSVG)return !1;
        var e = A.replace(/([A-Z])/g, function (A, e) {
            return "-" + e.toLowerCase()
        }).replace(/^ms-/, "-ms-"), t = createElement("div"), r = createElement("div"), n = createElement("span");
    ...
    url = url && window[url], Modernizr.addTest("bloburls", url && "revokeObjectURL" in url && "createObjectURL" in url), Modernizr.addAsyncTest(function () {
        ...
        try {
            var r, n, o = 'var hello = "world"', i = new Blob([o], {type: "text/javascript"}), d = URL.createObjectURL(i), a = new Worker(d);
    ...
    }(), Modernizr.addTest("cssgridlegacy", testAllProps("grid-columns", "10px", !0)), Modernizr.addTest("cssgrid", testAllProps("grid-template-rows", "none", !0)), Modernizr.addTest("displayrunin", testAllProps("display", "run-in"), {aliases: ["display-runin"]}), Modernizr.addTest("ellipsis", testAllProps("textOverflow", "ellipsis")), Modernizr.addTest("cssfilters", function () {
        ...
        function A() {
            function t() {
                try {
                    var A = createElement("div"), e = createElement("span"), t = A.style, r = 0, n = 0, o = !1, i = document.body.firstElementChild || document.body.firstChild;
            ...
            function r(A, e) {
                try {
                    var t = createElement("div"), r = createElement("span"), n = t.style, o = 0, i = !1, d = !1, a = !1, s = document.body.firstElementChild || document.body.firstChild;
            ...
            function n(A) {
                try {
                    var e, t = createElement("input"), r = createElement("div"), n = "lebowski", o = !1, i = document.body.firstElementChild || document.body.firstChild;
